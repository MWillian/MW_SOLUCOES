...
public class Client : Person
{
    ...
    public Client(Guid id, PersonName name, int age, string cpf, string phone, Address address, string email,int numberOfOrders = 0,ClientAccountStatus accountStatus = ClientAccountStatus.Active) : base(id, name, age, cpf, phone, address, email)
    {
